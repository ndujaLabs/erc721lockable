...
import "./ERC721LockedUpgradeable.sol";
...
contract ERC721LockedEnumerable is ERC721LockedUpgradeable, IERC721EnumerableUpgradeable {
  ...
  function __ERC721LockedEnumerable_init(string memory name_, string memory symbol_) internal onlyInitializing {
  ...
  function _addTokenToOwnerEnumeration(address to, uint256 tokenId) private {
    uint256 length = ERC721LockedUpgradeable.balanceOf(to);
  ...
  function _removeTokenFromOwnerEnumeration(address from, uint256 tokenId) private {
    ...
    uint256 lastTokenIndex = ERC721LockedUpgradeable.balanceOf(from) - 1;
